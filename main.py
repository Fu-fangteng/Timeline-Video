...
while True:
    ...
    if total_frames > total_blocks:
        ...
        if block_idx >= total_blocks:
            ...
            break
        block_x = (block_idx % cols) * gridSize
        block_y = (block_idx // cols) * gridSize
        ...
        if frame_idx % frames_per_block == frames_per_block - 1 or frame_idx == total_frames - 1:
            ...
            averages = calculate_average_from_accumulator(accumulator_grid[block_idx // cols, block_idx % cols])
